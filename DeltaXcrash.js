...
"title": `🖥️༐✲ 𝐌𝐬𝐠 𒑊 ${m.body || m.mtype}`,
"description": `⟠ DELTAXCRAS🔥 ⿻ 𝐂𝐋͢𝐢𝚵𝐍͢𝐓 々`,
"currencyCode": "IDR",
...
"title": "BUG DELTACRASH V3 [B.E.T.A]", 
...
╭•┈┈⛧┈♛ *𝖨𝖭𝖥𝖮𝖱𝖬𝖠𝖳𝖨𝖮𝖭 𝖴𝖲𝖤𝖱* ♛┈⛧┈┈•༶
ᯤ  𝖭𝖺𝗆𝖺 : ${pushname}
ᯤ  𝖲𝗍𝖺𝗍𝗎𝗌 : ${isPremium ? "Premium" : "Free"}
└──ᘏツ
...
ᯤ  ${prefix}self
ᯤ  ${prefix}public
ᯤ  ${prefix}addprem 62xx
ᯤ  ${prefix}delprem 62xx
ᯤ  ${prefix}addowner 62xx
ᯤ  ${prefix}delowner 62xx
╰×͜×

════「 *✦ NEW BUG DTCRSH V3 ✦* 」════
ᯤ  ${prefix}virus999 62xxx
ᯤ  ${prefix}restart-maker 62xxx
ᯤ  ${prefix}clear-data 62xxxx
ᯤ  ${prefix}delta-virus 62xxx
ᯤ  ${prefix}crash-total 62xxx
ᯤ  ${prefix}satanic999 62xxx
ᯤ  ${prefix}deltacrash  62xxx
╰×͜×
════「 *✦ NEW VIP BUG DTCRSH V3 ✦* 」════
ᯤ  ${prefix}reboot 62xxx
ᯤ  ${prefix}reset 62xxx
ᯤ  ${prefix}🗿 62xxx
ᯤ  ${prefix}🔥 62xxx
ᯤ  ${prefix}bug-gc <linkgroup>
ᯤ  ${prefix}ui-grup <linkgroup>
ᯤ  ${prefix}reset-gc <linkgroup>
ᯤ  ${prefix}kill-gc <120###@g.us>
╰×͜×
════「 *✦ NEW VVIP BUG DTCRSH V3 ✦* 」════
ᯤ  ${prefix}delta-novo <62xxx, jumlah>
ᯤ  ${prefix}virus-id <62xxx|jumlah>
ᯤ  ${prefix}reset-ui <62xxx, jumlah>
ᯤ  ${prefix}delta-crash1 <62xxx, jumlah>
ᯤ  ${prefix}maker1 <62xxx, jumlah>
ᯤ  ${prefix}maker404 <62xxx, jumlah>
╰×͜×`
           deltaxcrash.sendMessage(m.chat, { 
	           text: menu,
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
                            title: '「 ✦ 𝖲𝖢𝖱𝖨𝖯𝖳 𝖣𝖤𝖫𝖳𝖠𝖢𝖱𝖠𝖲𝖧 𝖵𝟥 ✦ 」',
                            //body: global.namaCreator,
                            thumbnailUrl: 'https://telegra.ph/file/d725cb646cb63f7559486.jpg', 
                            //sourceUrl: global.isLink,
                            previewType: "PHOTO", 
                            mediaType: 1,
...
break
//=================================================//
case '🗿': case 'delta-virus': case 'crash-total': case '🔥': {
